...
<html>
    ...
    <body>
    <h1 class="container text-center mt-5 ">____________________________ Sign in _____________________________</h1>
    <form class="form container mt-5 pt-5" action="signincheck.php" method="POST">
    <?php
        ...
        <div class="form-group">
            ...
            <input type="email " class="form-control firstbackgroundcolor" id="exampleInputEmail1" aria-describedby="emailHelp" name="name">
        ...
        <a href="signup.php" class=" btn btn-primary   d-inline-block">Sign Up</a>
